                                        ...
                                        <form className="" onSubmit={handleSubmit(onSubmit)}>
                                                <div className="row justify-content-between text-left my-3">
                                                    ...
                                                    <div className="form-group col-lg-6 flex-column d-flex">
                                                     ...
                                                     <input type="text" id="firstName" name="firstName" placeholder="Enter your first name"  className="form-control" {...register("firstName", { required: true })}/> 
                                                </div>
                                                        <div className="form-group col-sm-6 flex-column d-flex"> 

                                                    <input type="text" id="lastName" name="lastName" placeholder="Enter your last name"  className="form-control" {...register("lastName", { required: true })}/> 
                                                </div>
                                            </div>
                                                <div className="row justify-content-between text-left my-3">
                                                    ...
                                                    <input type="email" id="email" name="email" placeholder="Enter Your Email" className="form-control" {...register("email", { required: true })}/> 
                                                </div>
                                            </div>
                                            <div className="row justify-content-between text-left my-3">
                                                    <div className="form-group col-sm-12 flex-column d-flex"> 
